...
namespace MS.Services
{
    public class RoleService : BaseService, IRoleService
    {
        ...
        public async Task<ExecuteResult<Role>> Create(RoleRequest viewModel)
        {
        ...
        public async Task<ExecuteResult> Delete(RoleRequest viewModel)
        {
        ...
        public async Task<ExecuteResult> Update(RoleRequest viewModel)
        {
            ExecuteResult result = new ExecuteResult();
            //检查字段
